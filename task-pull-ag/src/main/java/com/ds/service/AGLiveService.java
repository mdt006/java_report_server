...
@Service
public class AGLiveService extends BaseService<AGLiveEntity> {
	private final Logger log = LoggerFactory.getLogger(AGCommon.LOG_AG_LIVE);
	@Autowired
	...
	public void setAuditEntity(Element info, AGLiveEntity liveEntity, ApiInfoEntity apiInfo) {
		...
		audit.setGameName(AuditGameNameEnum.AG_LIVE.toString());
